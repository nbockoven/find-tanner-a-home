<?php
  ...
  if(
    ...
    $msg = shell_exec( "cd ~/public_html/find-tanner-a-home.com; git checkout master; git fetch --all; git reset --hard origin/master; find . -type d -exec chmod 755 {} \; find . -type f -exec chmod 644 {} \;" );
  }
  else{
    $rand = rand(1000, 9999);
  }
